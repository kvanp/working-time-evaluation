...
def round_int_uni(value, base=100, step=10):
    """ Integer rounding
        ...
        base    The base value for rounding.
        step    The steps it will be round. If step is zero, it will be round
                to the zero base. If step is equvell base, it will be round to
                the base.
